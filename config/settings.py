...
APPS_DIR = ROOT_DIR.path('django_aiohttp_websockets')

env = environ.Env(
    DJANGO_DEBUG=(bool, False),
    DJANGO_SECRET_KEY=(str, 'CHANGEME!!!cyme6ndlv&0#6xo^frwt($5fuj%t5l08eu-!d=obq80ohp$cw('),
    DJANGO_ADMINS=(list, []),
    DJANGO_ALLOWED_HOSTS=(list, []),
    DJANGO_STATIC_ROOT=(str, str(APPS_DIR('staticfiles'))),
    DJANGO_MEDIA_ROOT=(str, str(APPS_DIR('media'))),
    DJANGO_DATABASE_URL=(str, 'postgis:///django_aiohttp_websockets'),
...
LOCAL_APPS = (
    ...
    'django_aiohttp_websockets.websockets',
)
